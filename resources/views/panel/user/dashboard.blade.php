                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="chart-content text-center">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-sm-6 col-6">
                                                    <div class="chart-stat">
                                                        <p class="mb-1">ارزش بازار</p>
                                                        <strong>19B USD</strong>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-sm-6 col-6">
                                                    <div class="chart-stat">
                                                        <p class="mb-1">در حال گردش</p>
                                                        <strong>29.4M BTC</strong>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-sm-6 col-6">
                                                    <div class="chart-stat">
                                                        <p class="mb-1">تمام زمان بالا</p>
                                                        <strong>19.783.06 USD</strong>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-sm-6 col-6">
                                                    <div class="chart-stat">
                                                        <p class="mb-1">نگه داشتن معمولی </p>
                                                        <strong>88 days</strong>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-sm-6 col-6">
                                                    <div class="chart-stat">
                                                        <p class="mb-1">فعالیت تجاری</p>
                                                        <strong>70% buy </strong>
                                                    </div>
                                                </div>
                                                <!-- <div class="col-xl-4 col-sm-6 col-6">
                            ...
                            <div class="col-xl-4 col-lg-12 col-xxl-4">
                                <div class="card balance-widget transparent">
                                    <div class="card-body">
                                        <div id="wallet-chart"></div>
                                        <div class="balance-widget">
                                            <h4>مجموع تعادل : <strong>$125480</strong></h4>
                                            <ul class="list-unstyled">
                                                <li class="d-flex">
                                                    <i class="cc BTC me-3"></i>
                                                    <div class="flex-grow-1">
                                                        <h5 class="m-0">بیت کوین</h5>
                                                    </div>
                                                    <div class="text-right">
                                                        <h5>0.000242 BTC</h5>
                                                        <span>0.125 USD</span>
                                        ...
                                        <div class="widget-card">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="widget-stat">
                                                    <div class="coin-title">
                                                        <span><i class="cc BTC-alt"></i></span>
                                                        <h5 class="d-inline-block ms-2 mb-3">بیت کوین
                                                            <span>(24h)</span>
                                                        </h5>
                                                    </div>
                                                    <h4>USD 1254.36 <span class="badge bg-success ms-2">+
                                        ...
                                        <div class="widget-card">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="widget-stat">
                                                    <div class="coin-title">
                                                        <span><i class="cc ETH-alt"></i></span>
                                                        <h5 class="d-inline-block ms-2 mb-3">اتریوم
                                                            <span>(24h)</span>
                                                        </h5>
                                                    </div>
                                                    <h4>USD 1254.36 <span class="badge bg-danger ms-2">-
                                        ...
                                        <div class="widget-card">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="widget-stat">
                                                    <div class="coin-title">
                                                        <span><i class="cc LTC-alt"></i></span>
                                                        <h5 class="d-inline-block ms-2 mb-3">لایت کوین
                                                            <span>(24h)</span>
                                                        </h5>
                                                    </div>
                                                    <h4>USD 1254.36 <span class="badge bg-primary ms-2">
                                            ...
                                            <form method="post" name="myform" class="currency_validate">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="d-flex justify-content-between mt-3">
                                                        ...
                                                        <h6 class="mb-0">$49750 باقی مانده است</h6>
                                                    </div>
                                                </div>
